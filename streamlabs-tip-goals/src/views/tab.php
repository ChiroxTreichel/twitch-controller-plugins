...
<div class="card">
    <div class="card-head">
        <h2><?= $e(translate('sl_tip.tab')) ?></h2>

        <?php if ($goals !== []): ?>
            <span class="hint"><?= $e(translate('sl_tip.count', [
    ...
    */ ?>
    <?php if (!$ready): ?>
        <div class="note note-warn">
            <?= $e(translate('sl_tip.no_credentials')) ?>
            <a href="<?= $e($url('/display/goals/tips/settings')) ?>"><?= $e(translate('sl_tip.to_settings')) ?></a>
        </div>
    <?php endif ?>
    ...
    */ ?>
    ...
    <?php if ($goals === []): ?>
        <p class="hint"><?= $e(translate('sl_tip.empty')) ?></p>
    <?php else: ?>
                ...
                <?php foreach ($goals as $i => $goal): ?>
                    <div class="tip-goal<?= $i === 0 ? ' is-current' : '' ?>">
                        <div class="tip-goal-head">
                            ...
                            <?php if ($i === 0): ?>
                                <span class="badge badge-ok"><?= $e(translate('sl_tip.current')) ?></span>
                            <?php endif ?>
                        ...
                        <div class="row">
                            <label class="field grow">
                                <span class="hint"><?= $e(translate('sl_tip.title')) ?></span>
                            ...
                            */ ?>
                            <label class="field">
                                <span class="hint"><?= $e(translate('sl_tip.current_amount')) ?></span>
                            ...
                            <label class="field">
                                <span class="hint"><?= $e(translate('sl_tip.target_amount')) ?></span>
                                <input class="input" type="number" step="0.01" min="0"
        ...
        <?php if ($canEdit): ?>
            <div class="tip-goal-actions">
                <?php foreach ($goals as $i => $goal): ?>
                    <div class="row">
                        <span class="tip-goal-order">#<?= (int) ($i + 1) ?></span>
                        <span class="grow"><?= $e($goal['title'] !== '' ? $goal['title'] : translate('sl_tip.unnamed')) ?></span>
                        ...
                        <form method="post" action="<?= $e($ziel) ?>">
                            ...
                            <button class="btn btn-small" type="submit" <?= $i === 0 ? 'disabled' : '' ?>
                                    title="<?= $e(translate('sl_tip.move_up')) ?>"
                                    aria-label="<?= $e(translate('sl_tip.move_up')) ?>">&uarr;</button>
                        </form>
                        ...
                        <form method="post" action="<?= $e($ziel) ?>">
                            ...
                            <button class="btn btn-small" type="submit" <?= $i === $letzte ? 'disabled' : '' ?>
                                    title="<?= $e(translate('sl_tip.move_down')) ?>"
                                    aria-label="<?= $e(translate('sl_tip.move_down')) ?>">&darr;</button>
                        </form>
                        ...
                        */ ?>
                        <?= $view->render('_confirm', [
                            ...
                            'question' => translate('sl_tip.confirm_delete', [
                                'name' => $goal['title'] !== '' ? $goal['title'] : translate('sl_tip.unnamed'),
                            ]),
    ...
    <?php if ($canEdit && count($goals) < $maxGoals): ?>
        <form class="row" method="post" action="<?= $e($ziel) ?>">
            ...
            <button class="btn" type="submit"><?= $e(translate('sl_tip.add')) ?></button>
        </form>
    <?php endif ?>
</div>
