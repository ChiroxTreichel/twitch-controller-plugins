    ...
    <div class="file-field">
        ...
        <?php if ($canEdit): ?>
            <button class="file-field-button" type="button"
                    ...
                    title="<?= $e(translate('sl_tip.alert.choose_file')) ?>">↑</button>
...
<div class="card">
    <div class="head-row">
        <h2 style="margin:0;"><?= $e(translate('sl_tip.alert.title')) ?></h2>
            ...
            <form method="post" action="<?= $e($target) ?>">
                ...
                */ ?>
                <button class="switch<?= $config['enabled'] ? ' is-on' : '' ?>" type="submit"
                        title="<?= $e(translate('sl_tip.alert.toggle_hint')) ?>"
                        aria-label="<?= $e(translate('sl_tip.alert.toggle_hint')) ?>">
        ...
        <?php else: ?>
            <span class="badge <?= $config['enabled'] ? 'badge-ok' : 'badge-off' ?>">
                <?= $e($config['enabled']
                    ? translate('sl_tip.alert.on')
                    : translate('sl_tip.alert.off')) ?>
            </span>
        <?php endif ?>
    </div>

    <p class="hint"><?= $e(translate('sl_tip.alert.lead')) ?></p>

    <p class="hint">
        <?= $e(translate('sl_tip.alert.placeholders')) ?>
    ...
    <form method="post" action="<?= $e($target) ?>">
        ...
        */ ?>
        <p class="hint"><?= $e(translate('sl_tip.alert.tiers_hint')) ?></p>
        ...
        <?php foreach ($config['tiers'] as $n => $stufe): ?>
            <div class="case-body" style="border:1px solid var(--line);border-radius:9px;padding:14px;margin:0 0 12px;">
                <div class="row">
                    <label class="field">
                        <span class="hint"><?= $e(translate('sl_tip.alert.min_amount')) ?></span>
                        ...
                        */ ?>
                        <div class="field">
                            ...
                            <button class="btn btn-ghost btn-small" type="submit"
                                ...
                                <?= $e(translate('sl_tip.alert.tier_remove')) ?>
                            </button>
                        </div>
                    <?php endif ?>
                </div>
                ...
                <label class="field">
                    <span class="hint"><?= $e(translate('sl_tip.alert.text')) ?></span>
                ...
                <div class="field">
                    <span class="hint"><?= $e(translate('sl_tip.alert.video')) ?></span>
                    <?php $dateifeld('tiers[' . $n . '][video]', $stufe['video'], 'video/*'); ?>
                </div>

                <div class="field">
                    <span class="hint"><?= $e(translate('sl_tip.alert.audio')) ?></span>
                ...
                */ ?>
                <label class="field">
                    <span class="hint"><?= $e(translate('sl_tip.alert.duration')) ?></span>
        ...
        <?php if ($canEdit && count($config['tiers']) < $maxTiers): ?>
            <div class="row">
                <button class="btn btn-ghost btn-small" type="submit" name="add_tier" value="1">
                    <?= $e(translate('sl_tip.alert.tier_add')) ?>
                </button>
            </div>
        <?php endif ?>
...
<?php if ($canTest): ?>
    <div class="card">
        <div class="card-head">
            <h2><?= $e(translate('sl_tip.alert.test')) ?></h2>
        </div>
        ...
        */ ?>
        <p class="hint"><?= $e(translate('sl_tip.alert.test_hint')) ?></p>
        ...
        <form method="post" action="<?= $e($target) ?>">
            ...
            <div class="row">
                <button class="btn btn-ghost" type="submit"><?= $e(translate('sl_tip.alert.test_send')) ?></button>
            </div>
        </form>
    </div>
<?php endif ?>
